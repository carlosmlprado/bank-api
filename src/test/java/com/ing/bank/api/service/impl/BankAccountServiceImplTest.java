...
//      given(bankAccountRepository.save(bankAccountEntity)).wil
    ...
    void should_delete(){
        ...
        bankAccountService.deleteBankAccountsByCustomerId(customerId);

        verify(bankAccountRepository, times(1)).deleteBankAccountsByCustomerId(customerId);
    }
